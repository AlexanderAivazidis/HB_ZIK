...
SaveH5Seurat(DietSeurat(
  ...
  dimreducs = NULL,
  graphs = NULL
), filename = "../data/jhubData/HB_ZIK/HB_ZIK/zikaGlioblastomas_10X_SeuratObject.h5Seurat", overwrite = TRUE)
Convert("../data/jhubData/HB_ZIK/HB_ZIK/zikaGlioblastomas_10X_SeuratObject.h5Seurat", dest = "h5ad")
...
Glioblastoma.SmartSeq.all$Celltype3 = as.vector(Glioblastoma.SmartSeq.all$Celltype2)
Glioblastoma.SmartSeq.all$Celltype3[Glioblastoma.SmartSeq.all$Celltype3 %in% c('AClike', 'OPClike', 'NPClike', 'MESlike')] = 'GSC'

DimPlot(Glioblastoma.SmartSeq.all, reduction = "umap", group.by = "Celltype")
DimPlot(Glioblastoma.SmartSeq.all, reduction = "umap", group.by = "Celltype3")
...
SaveH5Seurat(DietSeurat(
  ...
  dimreducs = NULL,
  graphs = NULL
), filename = "../data/jhubData/HB_ZIK/HB_ZIK/zikaGlioblastomas_SS_SeuratObject.h5Seurat")
Convert("../data/jhubData/HB_ZIK/HB_ZIK/zikaGlioblastomas_SS_SeuratObject.h5Seurat", dest = "h5ad")
